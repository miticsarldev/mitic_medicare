...
export function Caregiver() {
  return (
    <div className="p-6 bg-gray-200 flex flex-col items-center">
      <div className="bg-white p-6 rounded-lg shadow-md flex flex-col md:flex-row items-center max-w-6xl w-full">
        ...
        <div className="w-full md:w-2/3 md:pl-6">
          <h2 className="text-2xl font-bold text-center md:text-left">Vous êtes Soignant ?</h2>
