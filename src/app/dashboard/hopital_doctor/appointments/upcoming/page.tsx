...
const DoctorAppointments = () => {
  ...
  const handleAppointmentStatus = async (appointmentId: string, newStatus: "CONFIRMED" | "REJECTED" | "COMPLETED" | "CANCELED") => {
    try {
            ...
            filteredAppointments.map((appointment) => (
              <div 
                ...
                className={`p-6 rounded-lg shadow-md flex flex-col md:flex-row justify-between items-start md:items-center border-l-4 ${
                  ...
                  appointment.status === "REJECTED" || appointment.status === "CANCELED" ? "border-red-500" :
                  "border-gray-300"
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                {selectedAppointment.status === "CONFIRMED" && (
                  <Button 
                    onClick={() => {
                      handleAppointmentStatus(selectedAppointment.id, "COMPLETED");
                      setIsMedicalRecordModalOpen(true);
                    }}
                  >
                    <Stethoscope className="mr-2" size={18} /> Marquer comme terminé
                  </Button>
                )}
