          ...
          <div className="space-y-6">
              ...
              <Card className="shadow-sm">
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center gap-2 text-lg font-semibold text-gray-700 dark:text-white">
                    <User className="h-5 w-5 text-blue-600" /> Informations
                    patient
                  </CardTitle>
                  <Separator />
                </CardHeader>
                <CardContent className="pt-4 space-y-3">
                  ...
                  <InfoRow
                    ...
                    value={appointment.patient.medicalNotes}
                  />
                </CardContent>
              </Card>
              ...
              <div className="space-y-6">
                <Card className="shadow-sm">
                  ...
                  <CardContent className="pt-4 space-y-3">
                    ...
                    <InfoRow
                      ...
                      value={
                        appointment.doctor.specialization || "Non précisée"
                      }
                    />
                    <InfoRow
                      label="Département"
                ...
                <Card className="shadow-sm">
                  ...
                  <CardContent className="pt-4 space-y-3">
                    <InfoRow
                      label="Date"
                      value={format(new Date(appointment.scheduledAt), "PPP", {
                        locale: fr,
                      })}
                      icon={
                    ...
                    <InfoRow
                      label="Heure"
                      value={format(new Date(appointment.scheduledAt), "p", {
                        locale: fr,
                      })}
                      icon={
                    ...
                    <InfoRow
                      label="Type"
                      value={appointment.type || "Non précisé"}
                    />
                    <InfoRow
                      label="Motif"
            ...
            {appointment.medicalRecord && (
              <Card className="shadow-sm">
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center gap-2 text-lg font-semibold text-gray-700 dark:text-white">
                    <FileText className="h-5 w-5 text-blue-600" /> Dossier
                    Médical
                  </CardTitle>
                  <Separator />
                </CardHeader>
                <CardContent className="pt-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <InfoRow
                        label="Diagnostic"
                        value={appointment.medicalRecord.diagnosis}
                      />
                      <InfoRow
                        label="Traitement"
                        value={appointment.medicalRecord.treatment}
                      />
                      <InfoRow
                        label="Notes"
                        value={appointment.medicalRecord.notes || "Aucune note"}
                      />
                      <InfoRow
                        label="Suivi nécessaire"
                        value={
                          appointment.medicalRecord.followUpNeeded
                            ? "Oui"
                            : "Non"
                        }
                      />
                      {appointment.medicalRecord.followUpNeeded &&
                        appointment.medicalRecord.followUpDate && (
                          <InfoRow
                            label="Date de suivi"
                            value={format(
                              new Date(appointment.medicalRecord.followUpDate),
                              "PPP",
                              { locale: fr }
                            )}
                            icon={
                      ...
                      <InfoRow
                        label="Créé le"
                        value={format(
                          new Date(appointment.medicalRecord.createdAt),
                          "PPPp",
                          { locale: fr }
                        )}
                        icon={
                      ...
                      <InfoRow
                        ...
                        value={format(
                          new Date(appointment.medicalRecord.updatedAt),
                          "PPPp",
                          { locale: fr }
                        )}
                        icon={
                        ...
                        <div className="space-y-3">
                          {appointment.medicalRecord.prescriptions.map(
                            (prescription, index) => (
                              <Card
                                key={index}
                                className="border p-4 rounded-lg shadow-xs"
                              >
                                <CardContent className="p-0 space-y-2">
                                  ...
                                  <InfoRowSmall
                                    label="Posologie"
                                    value={`${prescription.dosage} - ${prescription.frequency}`}
                                  />
                                  <InfoRowSmall
                                    label="Durée"
                  ...
                  {appointment.medicalRecord.attachments.length > 0 && (
                    <div className="mt-6 space-y-4">
                      <h4 className="font-medium flex items-center gap-2 text-gray-700 dark:text-white">
                        <File className="h-4 w-4 text-blue-600" /> Pièces
                        jointes
                      </h4>
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        {appointment.medicalRecord.attachments.map(
                          (attachment, index) => (
                            <Card
                              key={index}
