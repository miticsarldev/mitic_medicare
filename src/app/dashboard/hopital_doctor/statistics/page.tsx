...
const StatisticsPage = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold text-gray-800 mb-3">Statistiques</h1>
      <h4 className="text-3sm font-light text-gray-800 mb-6">Visualisez et analysez les données de performance du medecin</h4>

      <div className="grid grid-cols-1 gap-8">
        {/* Nombre de patients */}
        <div className="bg-white p-6 shadow-lg rounded-lg">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-gray-700">Patients vus</h2>
            <select
        ...
        <div className="bg-white p-6 shadow-lg rounded-lg">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-gray-700">Revenus générés</h2>
            <select
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 shadow-lg rounded-lg">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-gray-700">Taux d&aposannulation</h2>
              <select
          ...
          <div className="bg-white p-6 shadow-lg rounded-lg">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-gray-700">Répartition par genre</h2>
              <select
