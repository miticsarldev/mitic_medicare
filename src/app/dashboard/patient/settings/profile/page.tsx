...
export default function ProfilePage() {
  ...
  const defaultValues: Partial<ProfileFormValues> = {
    ...
    bio: "Passionnée de yoga et de nutrition. Je suis attentive à ma santé et j'apprécie les médecins qui prennent le temps d'expliquer les traitements en détail.",
        ...
        <Card className="md:col-span-4 lg:col-span-3">
          ...
          <CardContent className="flex flex-col items-center">
            ...
            <div className="text-center">
              <h3 className="font-medium text-lg">Sophie Dupont</h3>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Vous pouvez mentionner vos intérêts, mode de vie, ou
                          toute information pertinente pour vos médecins.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Ces informations aideront vos médecins à mieux vous soigner.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Mentionnez toutes vos allergies connues, qu&apos;elles
                          soient alimentaires, médicamenteuses ou
                          environnementales.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
