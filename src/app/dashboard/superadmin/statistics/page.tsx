...
const revenueData = generateMonthlyData(12, 15000, 5000);
...
const regionData = [
  ...
  { name: "Provence-Alpes-Côte d'Azur", value: 12 },
  ...
  return (
    <div className="space-y-6">
          ...
          <CardHeader className="flex flex-row items-center">
            <div>
              <CardTitle>
                ...
                {selectedMetric === "revenue" && "Évolution des revenus"}
                {selectedMetric === "engagement" && "Évolution de l'engagement"}
              </CardTitle>
              <CardDescription>
            ...
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-2">
                <Badge variant="outline">
                  ...
                  {selectedMetric === "revenue" && "Total: €89,432"}
                  {selectedMetric === "engagement" &&
                    "Moyenne: 5,000 utilisateurs actifs/jour"}
                </Badge>
              </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Types d&apos;abonnements</CardTitle>
            <CardDescription>
      ...
      <Card>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-4">
              <h4 className="text-sm font-medium">
                Top régions par nombre d&apos;utilisateurs
              </h4>
              <div className="space-y-4">
                {regionData
        ...
        <CardFooter className="border-t px-6 py-3">
          <div className="flex items-center justify-between w-full">
            <Badge variant="outline">Total: 24,892 utilisateurs</Badge>
