  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Le médecin a été ajouté à la base de données.",
      });
    } catch (err) {
      setMessage("❌ Une erreur est survenue lors de la création du médecin.");
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <Label htmlFor="licenseNumber">N° Ordre des Médecins</Label>
          <Input
            name="licenseNumber"
        ...
        <div>
          ...
          >
            <SelectTrigger>
              <SelectValue
                placeholder={
                  loading ? "Chargement..." : "Sélectionner un département"
                }
              />
            </SelectTrigger>
            <SelectContent>
