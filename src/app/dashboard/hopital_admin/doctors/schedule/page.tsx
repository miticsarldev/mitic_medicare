                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="space-y-3 text-sm">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-medium">{format(parseISO(appointment.scheduledAt), "EEEE dd MMMM yyyy", { locale: fr })}</p>
                                <p className="text-muted-foreground">{format(parseISO(appointment.scheduledAt), "HH:mm", { locale: fr })}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
