...
const PLANS = [
  ...
  },
  {
    id: "STANDARD",
    label: "Standard",
    description: "Jusqu'à 50 médecins, support prioritaire",
    pricePerMonth: 50000, // XOF
  },
  {
    id: "PREMIUM",
    label: "Premium",
    description: "Médecins illimites, support 24/7",
    pricePerMonth: 150000, // XOF
  },
];
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>
            {requestSent ? "Paiement de l'abonnement" : "Renouveler l'abonnement"}
          </DialogTitle>
        </DialogHeader>
