...
import { Building2, Mail, Phone, Globe, MapPin, Calendar, FileText, Star } from "lucide-react"
    ...
    useEffect(() => {
        const fetchHospital = async () => {
            try {
                ...
                toast({
                    title: "Erreur",
                    description: "Une erreur est survenue lors de la récupération des informations de l'hôpital.",
                    variant: "destructive",
                })
            } finally {
                setLoading(false)
        ...
        return (
            <div className="max-w-6xl mx-auto p-6">
                <Card className="border-destructive">
                    <CardHeader>
                        <CardTitle className="text-destructive">Aucun hôpital trouvé</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p>Veuillez vérifier votre connexion ou contacter le support technique.</p>
                    </CardContent>
                </Card>
            </div>
        )
    ...
    return (
        <div className="max-w-6xl mx-auto p-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight">Profil de l&apos;hôpital</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Informations de contact de l&apos;hôpital</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                                ...
                                {editing ? (
                                    <>
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <Input name="state" value={formData.state || ""} onChange={handleChange} placeholder="État/Région" />
                                        </div>
                                    </>
                                ) : (
                                    <>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Présentation de votre établissement</CardDescription>
                    </CardHeader>
                    <CardContent>
                        {editing ? (
                            <Textarea
                            ...
                            <p className="text-muted-foreground whitespace-pre-line">{hospital.description}</p>
                        ) : (
