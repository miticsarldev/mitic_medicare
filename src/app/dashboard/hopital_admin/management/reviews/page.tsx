...
export default function AdminReviewPage() {
  ...
  const [targetFilter, setTargetFilter] = useState<ReviewTargetType | "ALL">(
    "ALL"
  );
          ...
          <>
                        ...
                        {[...Array(5)].map((_, i) => (
                          <Star
                            ...
                            className={cn("w-4 h-4", {
                              ...
                              "fill-none stroke-yellow-500/50":
                                i >= review.rating,
                            })}
                          />
                        ))}
            ...
            {pagination.totalPages > 1 && (
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6">
                <div className="text-sm text-muted-foreground">
                  {pagination.totalItems} avis • Page {pagination.currentPage}{" "}
                ...
                <div className="space-y-4">
                  <div className="flex flex-wrap items-center gap-4 text-sm">
                    ...
                    <div className="text-muted-foreground">
                      {selectedReview.isAnonymous
                        ? "Anonyme"
                        : selectedReview.author?.name || "Inconnu"}
                    </div>
                    <div className="text-muted-foreground">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm">{getTargetName(selectedReview)}</p>
                    </div>
                    <div className="space-y-1">
