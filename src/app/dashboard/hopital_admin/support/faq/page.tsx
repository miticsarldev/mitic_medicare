...
const faqs: FAQ[] = [
  {
    ...
    answer:
      "Rendez-vous dans le panneau d’administration, cliquez sur 'Utilisateurs' > 'Ajouter un médecin', puis remplissez les informations demandées.",
    category: "Utilisateurs",
  },
  {
    question: "Comment modifier les horaires d’ouverture de l’hôpital ?",
    answer:
      "Dans la section 'Paramètres', cliquez sur 'Horaires' pour mettre à jour les heures d’ouverture.",
    category: "Paramètres",
  },
  {
    question: "Comment désactiver un compte utilisateur ?",
    answer:
      "Allez dans 'Utilisateurs', sélectionnez l'utilisateur concerné, puis cliquez sur 'Désactiver le compte'.",
    category: "Utilisateurs",
  },
  {
    question: "Comment consulter les statistiques de fréquentation ?",
    answer:
      "La section 'Statistiques' vous permet de visualiser les rapports de fréquentation par service ou période.",
    category: "Statistiques",
  },
  {
    question: "Que faire en cas de problème technique sur la plateforme ?",
    answer:
      "Contactez le support via le bouton 'Assistance' dans le coin supérieur droit ou envoyez un ticket.",
