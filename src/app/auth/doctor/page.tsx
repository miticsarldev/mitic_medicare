    ...
    <div className="min-h-screen from-background to-blue-200 dark:from-background dark:to-blue-950/50">
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="max-w-screen-xl mx-auto md:flex md:justify-between space-y-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={setSelectedGouvernorat}
                  >
                    <SelectTrigger>
          ...
          {/* Image Section */}
          <div className="hidden md:flex md:w-1/2 text-center justify-end">
            ...
            <h2 className="mt-4 text-lg font-semibold">
              Renseignez votre plaque digitale
            </h2>
            <p className="text-gray-600 ml-4">
              Un profil personnalisé, accessible depuis la plateforme Medi
              <span className="text-[#107ACA]">Care</span> et depuis Google,
              pour être trouvé facilement
            </p>
          </div>
        </div>
        {/* Services Section */}
