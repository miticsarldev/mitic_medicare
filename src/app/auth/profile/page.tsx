      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-950 p-6 rounded-lg shadow-md">
            <h2 className="text-lg font-semibold text-center text-gray-900 dark:text-white">Modifier mes informations</h2>
            <div className="mt-4 space-y-4">
              ...
              <Input placeholder="Nom" className="w-full pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" />
              <Input placeholder="Prénom" className="w-full pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" />
              <div className="flex space-x-2">
                ...
                <Select>
                  ...
                  <SelectContent className="max-h-60 overflow-y-auto">
                    {annee.map((annee, i) => (
                      <SelectItem key={i} value={annee.value}>{annee.label}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
                <Select>
          ...
          <div className="bg-white dark:bg-gray-950 p-6 rounded-lg shadow-md flex flex-col h-full">
            <h2 className="text-lg font-semibold text-center text-gray-900 dark:text-white">Modifier mon mot de passe</h2>
