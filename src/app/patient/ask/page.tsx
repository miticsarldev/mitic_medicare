...
export default function AskQuestionForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-blue-100/50 dark:from-background dark:to-blue-950/50 text-gray-900 dark:text-gray-100">
              ...
              {step === 1 && (
                <>
                  ...
                  <Input
                    ...
                    className="w-full p-2 border rounded-md mt-1 dark:bg-gray-700 dark:text-gray-300"
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    <Switch
                      ...
                      onCheckedChange={setShowTreatment}
                  ...
                  {showTreatment && (
                    <Textarea
                      ...
                      onChange={handleChange}
                      className="w-full p-2 border rounded-md mt-2 dark:bg-gray-700 dark:text-gray-300"
                      placeholder="Décrivez votre traitement actuel..."
                    />
                  )}
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    <Switch
                      ...
                      onCheckedChange={setShowMedicalHistory}
                      className="dark:bg-gray-700 dark:text-gray-300"
                    />
                  </div>
                  {showMedicalHistory && (
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(value) =>
                        setFormData({ ...formData, hideName: value })
                      }
                      className="dark:bg-gray-700 dark:text-gray-300"
                    />
                  </div>
              ...
              {isAuthenticated && step === 2 && (
                <div className="text-center">
                  <p className="text-green-600 font-semibold">
                    Votre question est prête à être envoyée !
                  </p>
