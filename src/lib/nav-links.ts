...
export const patientNavItems = [
  ...
  },
  {
    ...
    items: [
      { title: "Prochains Rendez-vous", url: "/dashboard/patient/appointments/upcoming" },
      {
        title: "Historique des Rendez-vous",
        url: "/dashboard/patient/appointments/history",
      },
      { title: "Prendre un Rendez-vous", url: "/dashboard/patient/appointments/book" },
    ],
  },
  {
    ...
    items: [
      { title: "Voir Mon Dossier", url: "/dashboard/patient/medical-records/view" },
      { title: "Mises à jour", url: "/dashboard/patient/medical-records/updates" },
    ],
  },
  {
    ...
    items: [
      { title: "Rechercher un Médecin", url: "/dashboard/patient/doctors/search" },
      { title: "Centres Médicaux", url: "/dashboard/patient/doctors/hospitals" },
  ...
  },
  {
    ...
    items: [
      { title: "Donner un Avis", url: "/dashboard/patient/reviews/give-feedback" },
  ...
  },
  {
    ...
    items: [
      { title: "Mon Abonnement", url: "/dashboard/patient/subscription/details" },
      { title: "Mettre à Niveau", url: "/dashboard/patient/subscription/upgrade" },
    ],
  },
  {
